...
- generated_at: `2026-09-22T23:38:44+00:00`
- source: `tools/update_workbuddy_handoff.py` (reads git, registry, capability map, episode stream, snapshot, logs)
- commit: `b07b3f5` on `main`
...
- commits: 475
- HEAD: `b07b3f5` — fix(runtime): a run that has looked everywhere stops instead of walking back and forth (2026-09-23T07:38:25+08:00)
...
- `MAIL_CLAIM_REWARDS` success=78 rate=0.8864
- `NAVIGATE_RESEARCH_LAB` success=39 rate=0.975
- `OPEN_ALLIANCE` success=71 rate=0.8554
- `OPEN_ALLIANCE_GIFTS` success=88 rate=1.0
- `OPEN_DAILY` success=73 rate=0.9733
- `OPEN_EXPLORATION` success=38 rate=0.95
- `OPEN_HOME` success=297 rate=0.8486
- `OPEN_INFANTRY_TRAINING` success=35 rate=0.814
- `OPEN_INTEL` success=286 rate=0.88
...
- `OPEN_TASK_FROM_QUICK_PANEL_RESEARCH` success=7 failure=4 rate=0.6364
...
- `TRY_ORDINARY_CONTROL` success=40 failure=35 rate=0.5333

## E. Top failures

Failure | Count | Top skills
---|---:|---
`SEMANTIC_TARGET_NOT_VERIFIED` | 379 | OPEN_HOME(45), SELECT_RESOURCE(44), DISMISS_MAIL_GENERIC_REWARD(42)
`SAFE_BACK_NOT_PROVEN` | 88 | BACK(88)
...
`RECALL_DIALOG_NOT_OPEN` | 12 | SELECT_MARCH_TO_RECALL(12)
...
- status: **PASS**
- referenced screenshots: 12065  present: 12065
- missing: []
- episodes carrying screenshot references: 6194
...
- {"path": "E:\\无尽冬日智能体\\learning\\control_panel\\latest.log", "modified_at": "2026-09-22T23:36:37+00:00", "size_bytes": 9971, "last_stop_reason": "alliance_state_unknown"}
...
- ledger rows: 6121 (last 200 summarised)
...
- last step: LEAVE_FOREIGN_LAYER via ADB at 2026-09-22T23:38:24.342464+00:00
