...
TOP FAILURE IS RANKED BY RECENT FIRST: read `recent` (last 2 day(s), floor 2026-09-16T03:02:13.260888+00:00) before `count` (all-time). A failure type with recent=0 is history, not a current defect.
